import{d as n,j as i,L as v,l as o,r as l}from"./index-CbBFwd-e.js";import{H as b}from"./H2-CIqKufeY.js";import{S as z,u as y}from"./ScrittaCorpoPagina-NEyAy4w0.js";import{V as D,F as T}from"./VideoFotoIniziale-D5p2oyll.js";const G=n.p`
  text-align: center;
...
`;function j({fot:e,id:t,currentSlide:r,ritornoacapo:s}){return i.jsx(W,{id:t,cur:r,ritornoacapo:s,children:i.jsx("img",{src:e,alt:"foto",loading:"lazy"})})}const _=n.div`
  position: relative;
  height: 60vh;
  width: 100%;
  overflow: hidden;
...
`,p=[];for(;p.length<3;){let e=`./img/foto_${Math.floor(Math.random()*10)+1}.PNG`;!p.includes(e)&&p.push(e)}function K(){const{ref:e,inView:t}=y({triggerOnce:!0,rootMargin:"100px 0px"}),[r,s]=l.useState(0),[h,g]=l.useState(null),x=r===p.length-1,c=h===p.length-1;return l.useEffect(()=>{const d=setInterval(()=>{if(x){s(a=>(g(a),-1)),setTimeout(()=>s(a=>(g(a),a+1)),[100]);return}s(a=>(g(a),a+1))},5e3);return()=>clearInterval(d)},[p.length,x]),i.jsx(v,{to:"/galleria",children:i.jsx(_,{ref:e,inView:t,children:[...p.map((d,a,u)=>a<=2&&i.jsx(j,{id:-3+a,fot:d,currentSlide:r,ritornoacapo:c},"a"+a)),...p.map((d,a,u)=>i.jsx(j,{id:a,fot:d,currentSlide:r,ritornoacapo:c},a)),...p.map((d,a,u)=>a<=2&&i.jsx(j,{id:u.length+a,fot:d,currentSlide:r,ritornoacapo:c},"b"+a))]})})}const R=n.div`
  /* height: 40vh; */
  width: 50%;
