import{d as n,j as i,L as v,l as o,r as l}from"./index-Bnvcza8w.js";import{H as j}from"./H2-D2RraDDV.js";import{S as z,u as y}from"./ScrittaCorpoPagina-DZYlBWdJ.js";import{V as D,F as G}from"./VideoFotoIniziale-1-Wlii6p.js";const I=n.p`
  text-align: center;
...
`;function T({children:e}){return i.jsx(I,{children:e})}const O=n.span`
...
`;function _({children:e}){return i.jsx(A,{children:e})}const B=n.div`
  /* flex: 1; */
  /* max-height: 25%; */
  text-align: center;
  width: 100%;
...
`;function w({children:e,to:t,p:r}){const{ref:s,inView:h}=y({triggerOnce:!0,rootMargin:"0px 0px"});return i.jsxs(B,{ref:s,inview:h,children:[i.jsx(_,{children:i.jsx(v,{to:t,children:e})}),i.jsx(J,{children:i.jsx(v,{to:t,children:r})})]})}const N=n.div`
  margin-top: 8rem;
  /* margin-bottom: 5rem; */
  display: flex;
...
`;function b({fot:e,id:t,currentSlide:r,ritornoacapo:s}){return i.jsx(U,{id:t,cur:r,ritornoacapo:s,children:i.jsx("img",{src:e,alt:"foto",loading:"lazy"})})}const W=n.div`
  position: relative;
  height: 60vh;
  width: 100%;
  overflow: hidden;
...
`,p=[];for(;p.length<3;){let e=`static/build/img/foto_${Math.floor(Math.random()*10)+1}.PNG`;!p.includes(e)&&p.push(e)}function K(){const{ref:e,inView:t}=y({triggerOnce:!0,rootMargin:"100px 0px"}),[r,s]=l.useState(0),[h,g]=l.useState(null),x=r===p.length-1,c=h===p.length-1;return l.useEffect(()=>{const d=setInterval(()=>{if(x){s(a=>(g(a),-1)),setTimeout(()=>s(a=>(g(a),a+1)),[100]);return}s(a=>(g(a),a+1))},5e3);return()=>clearInterval(d)},[p.length,x]),i.jsx(v,{to:"/galleria",children:i.jsx(W,{ref:e,inView:t,children:[...p.map((d,a,u)=>a<=2&&i.jsx(b,{id:-3+a,fot:d,currentSlide:r,ritornoacapo:c},"a"+a)),...p.map((d,a,u)=>i.jsx(b,{id:a,fot:d,currentSlide:r,ritornoacapo:c},a)),...p.map((d,a,u)=>a<=2&&i.jsx(b,{id:u.length+a,fot:d,currentSlide:r,ritornoacapo:c},"b"+a))]})})}const R=n.div`
  ...
  ${e=>e.nofade&&o`
      ...
      opacity: 1;
    `}
`;function k({nofade:e,children:t}){const{ref:r,inView:s}=y({triggerOnce:!0,rootMargin:"-0px 0px"});return i.jsx(R,{nofade:e,ref:r,inView:s,children:t})}const Z=n.div`
  position: sticky;
  width: 100%;
  height: 100vh;
  top: 0;
...
`,V=n.div`
  ...
  overflow: hidden;
  border-radius: 5px;
`;function oi(){const e=l.useRef(null),[t,r]=l.useState(0),[s,h]=l.useState(!1),[g,x]=l.useState(!1),[c,d]=l.useState(!1),[a,u]=l.useState(!1),[S,$]=l.useState(()=>window.innerWidth>768?"large":"small");return l.useEffect(()=>{const f=()=>{if(e!=null&&e.current){const m=e.current.getBoundingClientRect();r(m.top+window.scrollY)}window.innerWidth>768?$("large"):$("small")};return f(),window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]),l.useEffect(()=>{const f=()=>{var C,M;const m=window.scrollY>=t-window.innerHeight?(window.scrollY-t+window.innerHeight)/((C=e==null?void 0:e.current)==null?void 0:C.offsetHeight)>=1?1:(window.scrollY-t+window.innerHeight)/((M=e==null?void 0:e.current)==null?void 0:M.offsetHeight):0;m>=.125?h(!0):h(!1),m>=.5?x(!0):x(!1),m>=.75?d(!0):d(!1),m>=.95?u(!0):u(!1),document.body.style.setProperty("--scroll",m)};return window.addEventListener("scroll",f,!1),()=>window.removeEventListener("scroll",f,!1)},[t]),i.jsxs(i.Fragment,{children:[S==="large"&&i.jsx(ii,{ref:e,children:i.jsxs(Z,{primoStep:s,children:[i.jsx(z,{type:"storia",terzoStep:c,children:i.jsx(j,{children:"Come ci siamo arrivati..."})}),i.jsxs(ei,{primoStep:s,children:[i.jsxs(L,{type:"primo",terzoStep:c,children:[i.jsx(Y,{children:i.jsx(H,{src:"static/build/img/2001.jpeg",alt:"Foto 2001"})}),i.jsxs(F,{primoStep:s,children:[i.jsx("span",{children:"2001"})," Ludwig nasce dal sogno della fondatrice Daniela, che dopo anni di esperienza in una grossa compagnia del settore, decise di creare il proprio salone. Un luogo in cui, insieme al suo team, accogliere ed esprimere il proprio amore verso i capelli, facendo sentire a casa ogni cliente."]})]}),i.jsxs(L,{type:"secondoCapitolo",secondoStep:g,terzoStep:c,quartoStep:a,children:[i.jsx(Y,{type:"seconda",terzoStep:c,children:i.jsx(H,{src:"static/build/img/IMG_5088.JPG",alt:"Foto 2024"})}),i.jsxs(F,{type:"secondoCapitolo",secondoStep:g,terzoStep:c,children:[i.jsx("span",{children:"2024"})," Dopo 23 anni, e con l’ingresso dei figli nell’attività, Ludwig decide di rinnovare per offrire un servizio ancora più esclusivo e di alta qualità. Per incantare chiunque varchi la soglia e consolidarsi punto di riferimento per tutti coloro che amano la bellezza dei propri capelli."]})]})]})]})}),S==="small"&&i.jsxs(ti,{children:[i.jsx(z,{type:"storia",children:i.jsx(j,{type:"storia",children:"Come ci siamo arrivati..."})}),i.jsxs(ni,{children:[i.jsxs(k,{nofade:!0,children:[i.jsx(V,{children:i.jsx(E,{src:"static/build/img/2001.jpeg"})}),i.jsxs(X,{children:[i.jsx("span",{children:"2001"})," Ludwig nasce dal sogno della fondatrice Daniela, che dopo anni di esperienza in una grossa compagnia del settore, decise di creare il proprio salone. Un luogo in cui, insieme al suo team, accogliere ed esprimere il proprio amore verso i capelli, facendo sentire a casa ogni cliente."]})]}),i.jsxs(k,{children:[i.jsx(V,{children:i.jsx(E,{src:"static/build/img/IMG_5088.JPG"})}),i.jsxs(X,{children:[i.jsx("span",{children:"2024"})," Dopo 23 anni, e con l’ingresso dei figli nell’attività, Ludwig decide di rinnovare per offrire un servizio ancora più esclusivo e di alta qualità. Per incantare chiunque varchi la soglia e consolidarsi punto di riferimento per tutti coloro che amano la bellezza dei propri capelli."]})]})]})]})]})}const q=n.div`
  width: 100%;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,ai=n.div`
  width: 100%;
  overflow: hidden;
`;function ci(){return i.jsxs(i.Fragment,{children:[i.jsx(D,{tipo:"video",src:"static/build/menuservizi.mp4",type:"video/mp4"}),i.jsxs(q,{children:[i.jsx(P,{type:"iniziale"}),i.jsx(Q,{}),i.jsxs(P,{type:"inframmezzo",author:"Eiselle",children:[" ",'"Per trovare il tuo look, la sperimentazione è sempre cosa buona e giusta: capelli lunghi, corti, lisci, ricci, morbidi o naturali, alla Monna Lisa, punk, spettinati, acconciati ad arte, non importa. Quello che importa è che sia siano sani, perché coi capelli sani puoi fare ciò che vuoi."']})]}),i.jsx(ai,{children:i.jsx(K,{})}),i.jsx(q,{type:"storia",children:i.jsx(oi,{})}),i.jsx(G,{})]})}export{ci as default};
